...
(add-to-list 'load-path "~/.emacs.d/plugins/emacs-gitlab/gitlab.el")
;;(require 'gitlab)
                                        ;setup gitlab
(setq gitlab-host "http://172.18.10.5"
      gitlab-username "elhakim"
      gitlab-password "3Lh4ki3m#10$")

;;(add-to-list 'load-path (expand-file-name "fence-edit" user-emacs-directory))
(add-to-list 'load-path "~/.emacs.d/plugins/fence-edit.el")
(require 'fence-edit)
(add-to-list 'load-path "~/.emacs.d/plugins/tiny-menu.el")
(require 'tiny-menu)
...
(use-package octopress
  :ensure t
  :config
  (setq octopress-blog-root (expand-file-name "~/ngeBlog")))
...
(custom-set-variables
 ...
 '(markdown-preview-custom-template "/Users/dzikers/.emacs.d/markdown-preview-template.html")
...
;;; used in OS X. Disable sRGB before seting up Powerline.
(when (memq window-system '(mac ns))
